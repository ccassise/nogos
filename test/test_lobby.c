...
void test_lobby_join_full(void) {
	T t;
	test_setup(&t);
...
void test_lobby_join_same_player(void) {
	T t;
	test_setup(&t);
...
void test_lobby_play_move(void) {
	T t;
	test_setup(&t);
...
void test_lobby_play_move_overflow(void) {
	T t;
	test_setup(&t);
...
void test_lobby_play_move_player_not_in_lobby(void) {
	T t;
	test_setup(&t);
